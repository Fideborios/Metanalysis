...
Furthemore, beacause of the calculation of the $\tau$ and the addition to the model, the weights change completely and sometimes this is used for reducing the weight of a study with a very small Variance (large Studies). 
...
A good solution is to use the Random-Effects model, that will reduce the weight of this study. The default estimator is the DerSimonian-Laird, that is making the weights to be more uniformly distributed.
